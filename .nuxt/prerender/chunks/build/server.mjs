import { defineComponent, createElementBlock, unref, hasInjectionContext, inject, getCurrentInstance, version, defineAsyncComponent, h, computed, ref, provide, shallowReactive, watch, Suspense, Fragment, createApp, toRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, mergeProps, withCtx, getCurrentScope, nextTick, useSSRContext } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/ofetch/dist/node.mjs';
...
import { createError as createError$1, sanitizeStatusCode, getRequestHeaders } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/h3/dist/index.mjs';
import { createPinia, setActivePinia, shouldHydrate } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/pinia/dist/pinia.prod.cjs';
import { defu } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/defu/dist/defu.mjs';
import { getActiveHead, CapoPlugin } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/@unhead/shared/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/radix3/dist/index.mjs';
import { hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs, ssrRenderStyle } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "slug",
    path: "/:slug(.*)*",
    component: () => import('./_...slug_-DP8bz5nm.mjs')
  }
];
...
const LazyContentCards = defineAsyncComponent(() => import('./ContentCards-CljB0ihH.mjs').then((r) => r["default"] || r.default || r));
const LazyContentFlipster = defineAsyncComponent(() => import('./ContentFlipster-D5CP7nVi.mjs').then((r) => r["default"] || r.default || r));
const LazyContentFollowers = defineAsyncComponent(() => import('./ContentFollowers-BTTnSrzG.mjs').then((r) => r["default"] || r.default || r));
const LazyContentGrid = defineAsyncComponent(() => import('./ContentGrid-ZrrcXAyq.mjs').then((r) => r["default"] || r.default || r));
const LazyContentLogos = defineAsyncComponent(() => import('./ContentLogos-BVvnGFoH.mjs').then((r) => r["default"] || r.default || r));
const LazyContentMenu = defineAsyncComponent(() => import('./ContentMenu-DMV-TFAm.mjs').then((r) => r["default"] || r.default || r));
const LazyContentSocial = defineAsyncComponent(() => import('./ContentSocial-DRypqPDs.mjs').then((r) => r["default"] || r.default || r));
const LazyContentTitle = defineAsyncComponent(() => import('./ContentTitle-ByFV86R2.mjs').then((r) => r["default"] || r.default || r));
const LazyContentVideo = defineAsyncComponent(() => import('./ContentVideo-D0tx5yMS.mjs').then((r) => r["default"] || r.default || r));
const LazyPortfolioContent = defineAsyncComponent(() => import('./PortfolioContent-6jjqhnF5.mjs').then((r) => r["default"] || r.default || r));
const LazyPortfolioProtection = defineAsyncComponent(() => import('./PortfolioProtection-3mgVHocS.mjs').then((r) => r["default"] || r.default || r));
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc-DF8JAsot.mjs').then((r) => r["default"] || r.default || r));
const LazyContentList = defineAsyncComponent(() => import('./ContentList-cEauCyo8.mjs').then((r) => r["default"] || r.default || r));
const LazyContentNavigation = defineAsyncComponent(() => import('./ContentNavigation-D8EewT74.mjs').then((r) => r["default"] || r.default || r));
const LazyContentQuery = defineAsyncComponent(() => import('./ContentQuery-D-LcUgK8.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer-7kN3XCNk.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown-Bj-Zbz9S.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseA = defineAsyncComponent(() => import('./ProseA-BY3W2PWb.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-BPw3XG1f.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-Cs9JppKL.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-BHv0Us7b.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-zIKUju7r.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-C4kozZRb.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-C8titHlc.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-Bidow6pB.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-aYb46SW9.mjs').then((r) => r["default"] || r.default || r));
...
const lazyGlobalComponents = [
  ["ContentCards", LazyContentCards],
  ["ContentFlipster", LazyContentFlipster],
  ["ContentFollowers", LazyContentFollowers],
  ["ContentGrid", LazyContentGrid],
  ["ContentLogos", LazyContentLogos],
  ["ContentMenu", LazyContentMenu],
  ["ContentSocial", LazyContentSocial],
  ["ContentTitle", LazyContentTitle],
  ["ContentVideo", LazyContentVideo],
  ["PortfolioContent", LazyPortfolioContent],
  ["PortfolioProtection", LazyPortfolioProtection],
...
const humblescroll_VWHyBoSbvn = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  {
    return;
  }
});
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CYbqmNCS.mjs').then((m) => m.default || m))
};
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><svg style="${ssrRenderStyle({ "display": "none" })}" xmlns="http://www.w3.org/2000/svg"><symbol id="svg-diamond" viewBox="0 0 75 75"><path d="M52 34C37 32 40 10 38 0h-2c-4 35 0 33-36 37v2c35 3 33 0 37 36h1c4-35 1-33 37-37v-2l-23-2Z"></path></symbol><symbol id="svg-cloud" viewBox="0 0 713 599"><path fill="#fff" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" style="${ssrRenderStyle({ "stroke-width": "var(--fo-stroke-width)" })}" vector-effect="non-scaling-stroke" d="M3 292c-5-37 19-70 42-86 29-21 59-19 69-19-12-51-7-105 45-132 57-29 128-11 171 33 15-53 61-99 119-82 56 16 65 71 65 122 58-31 134-35 178 23 41 54 10 122-46 150 50 38 75 110 28 161-39 42-104 32-144-3-10 58-30 117-93 134-65 17-110-33-138-85-43 50-115 62-168 19-46-37-56-102-22-151-12-2-32-6-52-19-15-9-48-29-54-65Z"></path></symbol></svg>`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DnOSF1a2.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CjIoO6hC.mjs'));
...
export { __nuxt_component_2$1 as _, useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, resolveUnrefHeadInput as d, entry$1 as default, useRoute as e, asyncDataDefaults as f, createError as g, useRequestEvent as h, injectHead as i, navigateTo as n, resolveRouteObject as r, useRouter as u };
