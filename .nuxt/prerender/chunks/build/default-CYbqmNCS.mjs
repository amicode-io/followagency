...
import { ref, mergeProps, unref, defineComponent, withCtx, createBlock, openBlock, createVNode, createTextVNode, useSSRContext } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSlot, ssrRenderStyle, ssrRenderAttr } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/vue/server-renderer/index.mjs';
import { _ as _imports_0$2 } from './virtual_public-2FTOlSxK.mjs';
...
import ContentMenu from './ContentMenu-DMV-TFAm.mjs';
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="u-visually-hidden"${_scopeId}>Strefa tylko dla klient\xF3w</span><img${ssrRenderAttr("src", _imports_0)} width="384" height="149" alt=""${_scopeId}>`);
          } else {
            return [
              createVNode("span", { class: "u-visually-hidden" }, "Strefa tylko dla klient\xF3w"),
              createVNode("img", {
                src: _imports_0,
                width: "384",
                height: "149",
      ...
      _push(`<address> Chocimska 35/3<br> 00-791 Warszawa </address></div></div><div class="footer__end"><a href="https://www.linkedin.com/company/follow-sm" target="_blank" class="footer__external">LinkedIn</a><span>\xA9 2025 Follow Agency, All Rights Reserved.</span><a href="#top" class="footer__top">Go to the top</a></div></div></footer>`);
    };
  }
});
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_AtomsCursor = __nuxt_component_2$1;
...
//# sourceMappingURL=default-CYbqmNCS.mjs.map
