...
import { defineComponent, useSSRContext, useId, ref, mergeProps, unref, withCtx, createVNode } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderList, ssrRenderComponent, ssrRenderClass, ssrRenderStyle } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/vue/server-renderer/index.mjs';
import { gsap } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/gsap/dist/gsap.js';
      ...
      ssrRenderList(_ctx.cards, ({ text, number }, index) => {
        _push(ssrRenderComponent(_component_HumbleScroll, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            ...
            var _a, _b;
            if (_push2) {
              _push2(`<article class="${ssrRenderClass(`element c-card c-card--${index + 1}`)}" data-v-a9aa0e40${_scopeId}><p class="element__inner" style="${ssrRenderStyle(`--strong-width: ${String(number).length}ch`)}" data-v-a9aa0e40${_scopeId}>${(_a2 = sprintf(text, ((_a = unref(cardsTween)[index]) == null ? void 0 : _a.tweened) || 0.01)) != null ? _a2 : ""}</p></article>`);
            } else {
              return [
                createVNode("article", {
...
export { ContentCards as default };
//# sourceMappingURL=ContentCards-CljB0ihH.mjs.map
