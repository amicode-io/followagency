import { ref, shallowRef, toRef, getCurrentInstance, onServerPrefetch, unref } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/vue/index.mjs';
import { a as useNuxtApp, f as asyncDataDefaults, b as useRuntimeConfig, h as useRequestEvent, g as createError } from './server.mjs';
import { withBase, withLeadingSlash, joinURL, withoutTrailingSlash } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/ufo/dist/index.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-BIzBnOvc.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-DS-Xa9BF.mjs.map
