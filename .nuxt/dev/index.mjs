import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setResponseHeaders, setHeaders, sendRedirect, proxyRequest, createError, getQuery as getQuery$1, getCookie, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, readBody, getResponseStatusText } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { mkdirSync } from 'node:fs';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { parentPort, threadId } from 'node:worker_threads';
import _RemarkEmoji from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/remark-emoji/index.js';
import { createStorage, prefixStorage } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/unstorage/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL, withLeadingSlash, withoutTrailingSlash, isRelative } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/ufo/dist/index.mjs';
import { hash } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/ohash/dist/index.mjs';
import defu, { defuFn, defu as defu$1 } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/defu/dist/defu.mjs';
import { extname } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/pathe/dist/index.mjs';
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/scule/dist/index.mjs';
import { unified } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/unified/index.js';
import { toString as toString$1 } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/mdast-util-to-string/index.js';
import { postprocess, preprocess } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/micromark/dev/index.js';
import { stringifyPosition } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/micromark-util-resolve-all/index.js';
import { normalizeUri } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/micromark-util-sanitize-uri/dev/index.js';
import remarkParse from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/remark-parse/index.js';
import remark2rehype from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/remark-rehype/index.js';
import remarkMDC, { parseFrontMatter } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/remark-mdc/dist/index.mjs';
import remarkGFM from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/remark-gfm/index.js';
import rehypeExternalLinks from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/rehype-external-links/index.js';
import rehypeSortAttributeValues from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/rehype-raw/index.js';
import { detab } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/detab/index.js';
import { toString } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/hast-util-to-string/index.js';
import Slugger from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/github-slugger/index.js';
import destr, { destr as destr$1 } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/destr/dist/index.mjs';
import slugify from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/slugify/slugify.js';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/devalue/index.js';
import { renderToString } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/@unhead/ssr/dist/index.mjs';
import { createHooks } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/unenv/runtime/fetch/index.mjs';
import { klona } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/klona/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/radix3/dist/index.mjs';
import { getContext } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/unctx/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/consola/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/errx/dist/index.js';
import { isVNode, unref, version } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/vue/index.mjs';
import chalk from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/chalk/source/index.js';
import { HtmlValidate, formatterFactory } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/html-validate/dist/es/index.js';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/@unhead/shared/dist/index.mjs';
...
const _b8WW2BDEZK = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/mikolagnatuk/Downloads/follow-www-main";

const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"pl"}};
...
const serverAssets = [{"baseName":"server","dir":"/Users/mikolagnatuk/Downloads/follow-www-main/server/assets"}];
...
storage$1.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"/Users/mikolagnatuk/Downloads/follow-www-main/content"}));
storage$1.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/mikolagnatuk/Downloads/follow-www-main/.nuxt/content-cache"}));
storage$1.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/mikolagnatuk/Downloads/follow-www-main"}));
storage$1.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/mikolagnatuk/Downloads/follow-www-main/server"}));
storage$1.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/mikolagnatuk/Downloads/follow-www-main/.nuxt"}));
storage$1.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/mikolagnatuk/Downloads/follow-www-main/.nuxt/cache"}));
storage$1.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/mikolagnatuk/Downloads/follow-www-main/.data/kv"}));
...
const _83q886e17R = defineNitroPlugin(async (nitro) => {
...
const useChecker = (validator, usePrettier = false, logLevel = "verbose") => {
  ...
  const checkHTML = async (url, html) => {
    ...
    try {
      if (usePrettier) {
        const { format } = await import('file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/prettier/index.mjs');
...
const _ovTIw1LVRE = (function(nitro) {
...
const _lazy_weEt5S = () => Promise.resolve().then(function () { return auth_post$1; });
const _lazy_mBDqGW = () => Promise.resolve().then(function () { return renderer$1; });
...
const handlers = [
  ...
  { route: '/api/_content/cache.json', handler: _0dK3XG, lazy: false, middleware: false, method: "get" },
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file:///Users/mikolagnatuk/Downloads/follow-www-main/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const getClientManifest = () => import('file:///Users/mikolagnatuk/Downloads/follow-www-main/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/mikolagnatuk/Downloads/follow-www-main/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
