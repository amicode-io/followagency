...
import { a as useNuxtApp, f as asyncDataDefaults, g as createError, b as useRuntimeConfig, h as useRequestEvent } from "../server.mjs";
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import("./client-db-BIzBnOvc.js").then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-DS-Xa9BF.js.map
