...
import { defineComponent, computed, mergeProps, withCtx, unref, createVNode, useSSRContext, useId, createBlock, openBlock } from "vue";
import { ssrRenderComponent, ssrRenderAttr, ssrRenderStyle, ssrRenderAttrs, ssrRenderList } from "vue/server-renderer";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-1tPrXgE0.js";
import { _ as _imports_0 } from "./virtual_public-2FTOlSxK.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(auth).isAuth) {
        ...
        _push(ssrRenderComponent(_component_HumbleScroll, { animation: "fade up" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="c-portfolio__text element" data-v-6d003dd3${_scopeId}><div class="element__inner" data-v-6d003dd3${_scopeId}><p data-v-6d003dd3${_scopeId}>witaj w krainie pięknych kreacji</p></div></div>`);
            } else {
              return [
                createVNode("div", { class: "c-portfolio__text element" }, [
                  createVNode("div", { class: "element__inner" }, [
                    createVNode("p", null, "witaj w krainie pięknych kreacji")
                  ])
                ])
              ];
            }
...
//# sourceMappingURL=PortfolioContent-6jjqhnF5.js.map
